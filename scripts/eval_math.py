...
AVAILABLE_MODES = {
    ...
    "hcot": GenerationMode(name="HCoT Prune", generate_fn=_sample, kwargs={"use_cache": False, "prune_aware": True}),
    "hcot-cached": GenerationMode(name="HCoT Prune (Cached)", generate_fn=_sample, kwargs={"use_cache": True, "prune_aware": True}),
    "hcot-agnostic": GenerationMode(name="HCoT Prune-Agnostic", generate_fn=_sample, kwargs={"use_cache": False, "prune_aware": False}),
}
